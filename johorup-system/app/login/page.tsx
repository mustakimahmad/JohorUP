  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
        ...
        {!showManualLogin ? (
          <>
            {/* Google SSO Button - only show if configured */}
            ...
            <button
              ...
              className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors font-medium mb-6"
            >
              {process.env.NEXT_PUBLIC_GOOGLE_SSO_ENABLED === 'true' ? 'Masuk dengan email/password' : 'Log Masuk'}
            </button>
          </>
        ) : (
          <>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="text-xs text-gray-500 space-y-1">
            {process.env.NEXT_PUBLIC_GOOGLE_SSO_ENABLED === 'true' ? (
              ...
              <p>📧 <strong>Manual Login:</strong> Demo mode - Google SSO not configured</p>
            )}
